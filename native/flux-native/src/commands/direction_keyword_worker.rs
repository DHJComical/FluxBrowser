...
use crate::protocol::direction_keywords::{
    AnalyzeDirectionKeywordsRequest, AnalyzeDirectionKeywordsResponse, DirectionMatch,
};
use regex::Regex;
...
pub fn run() {
    ...
    for line_result in stdin.lock().lines() {
        ...
        let response = AnalyzeDirectionKeywordsResponse {
            ...
            matches: analyze_text(&request.text),
        };
...
fn analyze_text(text: &str) -> Vec<DirectionMatch> {
